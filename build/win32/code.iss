...
AppPublisher=Neuronal
AppPublisherURL=https://neuronal.ia.br/lumina
AppSupportURL=https://neuronal.ia.br/lumina
AppUpdatesURL=https://neuronal.ia.br/lumina
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=Lumina-win32-{#Arch}-{#InstallTarget}-setup
Compression=lzma
