...
Lumina separately records basic usage like the number of messages people are sending. If you'd like to disable Lumina metrics, you may do so in Lumina's Settings.
`;
